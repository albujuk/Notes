...
Digital catalog of thousands of software listings from independent software vendors. Find, test, and buy software that runs on AWS. Each listing includes pricing options and customer reviews.
...
Global community of partners that build solutions and services on AWS. Partners and AWS collaborate to solve technical challenges and deliver customer value.

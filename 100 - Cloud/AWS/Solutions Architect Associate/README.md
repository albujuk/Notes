...
| 10f | CloudWatch | [[100 - Cloud/AWS/Solutions Architect Associate/CloudWatch\|CloudWatch]] | Metrics (custom, namespaces, dimensions, metric streams), Logs (log groups/streams, Logs Insights, S3 export, subscriptions, Unified Agent), Alarms (states, targets, composite alarms, EC2 recovery), EventBridge (scheduling, event patterns, cross-account, archiving, schema registry), Container Insights, Lambda Insights, Contributor Insights, Application Insights, Network Synthetic Monitor |

...
| 10h | KMS | [[100 - Cloud/AWS/Solutions Architect Associate/KMS\|KMS]] | Key types (symmetric/asymmetric, AWS owned/managed/customer), key policies, key rotation, multi-region keys, client-side encryption (DynamoDB/Aurora Global), S3 replication encryption |

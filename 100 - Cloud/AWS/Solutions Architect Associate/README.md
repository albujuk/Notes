...
| 5 | S3 | [[100 - Cloud/AWS/Solutions Architect Associate/S3\|S3]] | Buckets, versioning, replication, storage classes (deep dive), lifecycle rules, Express One Zone, Requester Pays, event notifications, performance (multi-part, transfer acceleration, byte-range), batch operations |

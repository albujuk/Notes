...
| **Platform** | Implement cloud technology for adoption requirements | N/A |
...
|----------|-------------|-------------|
| **Relocate** | N/A | Move VMs/containers already running on-premises to cloud as-is |
...
| **Retire** | N/A | Remove unused apps; 10%+ of portfolios qualify |

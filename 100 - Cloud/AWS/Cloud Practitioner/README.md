...
| --- | -------------------------- | ------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | Compute                    | [[Compute]]                | EC2, multi-tenancy, vertical/horizontal scaling, cloud vs on-premises, Lambda, Beanstalk, Batch, Lightsail, Outposts                                                             |
| 2   | Storage                    | [[Storage]]                | Overview: block vs object vs file storage                                                                                                                                        |
| 2a  | Block Storage              | [[BlockStorage]]           | EC2 instance store, EBS, EBS snapshots, Data Lifecycle Manager                                                                                                                   |
| 2b  | S3                         | [[S3]]                     | Objects, buckets, storage classes, lifecycle management                                                                                                                          |
| 2c  | File Storage               | [[FileStorage]]            | EFS, FSx (Windows, NetApp ONTAP, OpenZFS, Lustre)                                                                                                                                |
| 2d  | Storage Gateway            | [[StorageGateway]]         | Hybrid cloud storage; File, Volume, and Tape gateway types                                                                                                                       |
| 3   | Containers                 | [[Containers]]             | ECR, ECS, EKS, Fargate                                                                                                                                                           |
| 4   | Global Infrastructure      | [[Global Infrastructure]]  | Regions, AZs, edge locations, local zones, Outposts                                                                                                                              |
| 5   | CloudFormation             | [[CloudFormation]]         | IaC, templates, stacks, change sets, CDK, SAM                                                                                                                                    |
| 6   | Networking                 | [[Networking]]             | VPC, subnets, internet/NAT gateway, route tables, security groups, NACLs, Route 53, CloudFront, Global Accelerator, API Gateway                                                  |
...
| 12  | Security                   | [[Security]]               | Shared responsibility model; IAM (users, groups, roles, policies, least privilege); IAM Identity Center (SSO, federation); Secrets Manager; Systems Manager; IAM Access Analyzer |
